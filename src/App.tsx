...
export default function App() {
  ...
  useEffect(() => {
    ...
    const phone = loadFromLocalStorage(STORAGE_KEYS.PROFILE_PHONE, '');
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      ...
      case 'my_part':
        ...
        />;
      case 'profile':
        return <Profile navigate={navigate} onEmailUpdate={setProfileEmail} onNameUpdate={setProfileName} onPhoneUpdate={setProfilePhone} savedEmail={profileEmail} savedName={profileName} savedPhone={profilePhone} />;
      case 'liveStream':
